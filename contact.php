...
<title>London Dinner Club - exclusive dinner parties and drinks events in London :: contact us ::  London Dinner Club</title>
...
<!-- main content area -->
	...
	<div id="contentcol1">
	    ...
	    <p><strong><span class="righthandpic"><img src="images/asian_dinner_1.jpg" alt="London Dinner Club contact" width="250" height="250" /></span></strong>
	    <table width="296" height="59" border="0" cellpadding="0" cellspacing="0">
          <tr align="left" valign="top">
            <td><strong>Email:</strong></td>
            <td>&nbsp;</td>
            <td><a href="mailto:info@londondinnerclub.org">info@londondinnerclub.org</a></td>
          </tr>
        </table>
	    <p> <br>
        <br>
