    ...
    <div class="container relative">
       ...
       <?php
		if(isset($_POST['Submit']))
		{
			...
			{
				$errors[] = "Please enter proper information for the Height";
			}
            ...
            if(stripos($_POST['Height'], '[/url]') !== false || stripos($_POST['Height'], 'http') !== false)
			{
				$errors[] = "Please enter proper information for the Height without links";
			}
